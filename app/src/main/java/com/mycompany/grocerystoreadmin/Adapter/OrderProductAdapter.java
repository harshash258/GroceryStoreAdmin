...
public class OrderProductAdapter extends RecyclerView.Adapter<OrderProductAdapter.ViehHolder> {

    Context mContext;
    List<OrderProducts> mList;

    public OrderProductAdapter(Context mContext, List<OrderProducts> mList) {
