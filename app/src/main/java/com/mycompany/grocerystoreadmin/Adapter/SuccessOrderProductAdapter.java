...
public class SuccessOrderProductAdapter extends RecyclerView.Adapter<SuccessOrderProductAdapter.ViehHolder> {

    Context mContext;
    List<OrderProducts> mList;

    public SuccessOrderProductAdapter(Context mContext, List<OrderProducts> mList) {
