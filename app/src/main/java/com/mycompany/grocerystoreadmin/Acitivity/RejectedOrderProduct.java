...
import com.mycompany.grocerystoreadmin.Adapter.RejectedOrderProductAdapter;
...
public class RejectedOrderProduct extends AppCompatActivity {

    RecyclerView recyclerView;
    List<OrderProducts> list;
    RejectedOrderProductAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rejected_order_product);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Admin Order")
                .child("Previous Order").child("Order Cancelled").child(id).child("Products");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new RejectedOrderProductAdapter(RejectedOrderProduct.this, list);
